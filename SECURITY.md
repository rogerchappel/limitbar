...
Replace this section with the supported versions for `limitbar`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `limitbar` explicitly provides them.
